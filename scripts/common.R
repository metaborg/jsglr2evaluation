...
colors      <- c("#8c510a",  "#bf812d",  "#dfc27d",  "#f6e8c3",     "#b5b5b5",          "#f5f5f5",             "#c7eae5", "#80cdc1", "#35978f",         "#01665e")
allVariants <- c("standard", "elkhound", "recovery", "incremental", "recoveryElkhound", "recoveryIncremental", "jsglr1",  "antlr",   "antlr-optimized", "tree-sitter")
