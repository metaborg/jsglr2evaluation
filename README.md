...
The default configuration includes imploding, multiple languages, sources, variants and evaluation scopes (batch parsing, incremental parsing, memory measurements) and therefore takes a long to execute.
